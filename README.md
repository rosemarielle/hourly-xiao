# Hourly Xiao
Check out the bot on [Twitter](http://twitter.com/hourlyadeptus)!

Current Features:
- Chooses from a list of quotes of Xiao from Genshin Impact.
...
- Click the settings above and fork this project!
...
- Send a GET or POST request using [Postman](https://chrome.google.com/webstore/detail/postman/fhbjgbiflinjbdggehcddcbncdddomop?hl=en) to `{Project URL}/tweet` (for instance: `https://tracery-twitter-bot.glitch.me/tweet` for the `tracery-twitter-bot` project)
